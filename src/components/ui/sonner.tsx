...
export const useToast = () => {
  const showToastWithDefaultLocale = (
    message: string,
  ...
  const toastNote = (message: string, options?: ToastOptions) =>
    showToast(message, { ...options, type: 'note' });

  return {
    showToast: showToastWithDefaultLocale,
    toastSuccess,
    toastError,
    toastNote,
  };
...
export const toastNote = (message: string, options?: ToastOptions) =>
  showToast(message, { ...options, type: 'note' });
